def berry_finder(t):
    ...
    if is_leaf(t):
        ...
        if label(t) == 'berry':
            return True
        return any([berry_finder(i) for i in branches(t)])
...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    "*** YOUR CODE HERE ***"
    if is_leaf(t):
        return tree(lokis_replacement) if label(t) == 'loki' else t
    else:
        return tree(label(t), [replace_loki_at_leaf(i, lokis_replacement) for i in branches(t)])
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    des_city = make_city('des', lat, lon)
    return get_name(city_a) if distance(des_city, city_a) < distance(des_city, city_b) else get_name(city_b)
...
def dejavu(t, n):
    ...
    if is_leaf(t):
        ...
        return any([dejavu(i, n - label(t)) for i in branches(t)])
...
def hailstone_tree(n, h):
    ...
    if h == 0:
        return tree(n)
    elif (n - 1) % 3 == 0 and (n - 1) // 3 != 1 and n != 1:
